...
* [**FAQ Chatbot**](https://github.com/ntsmk/chatbot-for-internal-member) - RAG-based support system (Vertex AI + Supabase vector DB) + deployed on GCP Cloud Run + K3s (Kubernetes)
