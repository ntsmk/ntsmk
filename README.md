...
* [**FAQ Chatbot**](https://github.com/ntsmk/chatbot-for-internal-member) - RAG(Vertex AI + Supabase vector DB that contains internal Wiki page) + deployed on GCP Cloud Run + K3s (Kubernetes)
